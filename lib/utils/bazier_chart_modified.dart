...
// import 'package:swasthyasetu/utils/bezier_chart_config_modified.dart';
// import 'package:swasthyasetu/utils/bezier_line_modified.dart';
// import 'package:swasthyasetu/utils/my_single_child_sv_modified.dart';
//
...
//     RenderBox? renderBox = context.findRenderObject() as RenderRepaintBoundary?;
...
//
//         if (_currentBezierChartScale == BezierChartScale.WEEKLY) {
//           //var data = serie[0].data;
//           /*List<String> split = key.split(",");
//               int year = int.parse(split[0]);
//               int month = int.parse(split[1]);
//               int day = int.parse(split[2]);*/
//           var data = widget.series![0].data;
//           for (int i = 0; i < widget.series!.length; i++) {
//             /*final value = data[i].date;
//             final date = DateTime(year, month, day, 0);*/
//             newDataPoints.add(
//               DataPoint<DateTime>(
//                 value: data[i].value,
...
//                         ? _yValues!.first
//                         : 0.0);
//                 final steps = widget.config!.stepsYAxis > 0
