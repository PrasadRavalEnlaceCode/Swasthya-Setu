...
class DoctorLibraryScreen extends StatefulWidget {
  String? patientIDP;
  ...
  DoctorLibraryScreen({String? patientIDP}) {
    this.patientIDP = patientIDP;
  }

  @override
  State<StatefulWidget> createState() {
    return DoctorLibraryScreenState();
  }
}

class DoctorLibraryScreenState extends State<DoctorLibraryScreen> {
  ...
  @override
  void didUpdateWidget(DoctorLibraryScreen oldWidget) {
          ...
          child: FloatingActionButton(
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          AddDocumentScreen(widget.patientIDP!))).then((value) {
                getPatientReport(context);
              });
            },
                                          ...
                                          onTap: () {
                                            if (isADocument(index)) {
                                              downloadAndOpenTheFile(
                                                  "${baseImagePath}images/patientdocument/${listPatientReport[index].reportImage}",
                                                                ...
                                                                : InkWell(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: CachedNetworkImage(
                                                                          ...
                                                                          imageUrl: "${baseImagePath}images/patientdocument/${listPatientReport[index].reportImage}",
                                                                          fit: BoxFit.fitWidth,
                                                                          width: SizeConfig.blockSizeHorizontal! * 35,
                                                                          height: SizeConfig.blockSizeHorizontal! * 35),
                                                                    ),
  ...
  Future<String> getPatientReport(BuildContext context) async {
    ...
    String loginUrl = "${baseURL}patientDocumentData.php";
    ProgressDialog? pr;
