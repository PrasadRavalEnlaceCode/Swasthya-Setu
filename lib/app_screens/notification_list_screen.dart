...
class NotificationListState extends State<NotificationList> {
  List<ModelNotificationList>? listNotification;
  bool notificationListApiCalled = false;
  ...
  void initState() {
    super.initState();
    listNotification = [];
    notificationListApiCalled = false;
              ...
              ? ListView.builder(
                  ...
                  itemBuilder: (context, pos) => InkWell(
                        ...
                        child: Padding(
                          ...
                          child: listNotification![pos].notificationType ==
                                  "general"
                              ? Card(
                                  child:
                                      /*Padding(
                              ...
                              : listNotification![pos].notificationType ==
                                      "appointment"
                                  ? Card(
  ...
  bool checkIfDateIsLowerThanNow(BuildContext contextMain,
    ...
    DateTime now = DateTime.now();
    if (selectedDate.difference(now).inDays == -1) {
