...
class _PMRTableScreenState extends State<PMRTableScreen> {
                                  ...
                                  Row(
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: (){
                                          getPMRPdf(widget.PatientIDP,widget.patientindooridp);
                                        },
                                      ),
                                      // InkWell(
                                      //   child: Center(
  ...
  void getPMRPdf(String PatientIDF,PatientIndoorIDF) async {
    print('getIpdData');
    ...
    try{
      ...
      if (model.status == "OK") {
        ...
        String baseInvoiceURL= "${baseImagePath}images/PMR/";
