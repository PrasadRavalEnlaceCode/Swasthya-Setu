...
import 'package:swasthyasetu/app_screens/ipd/add_to_ot_screen.dart';
import 'package:swasthyasetu/app_screens/ipd/advise_investigation_screen.dart';
import 'package:swasthyasetu/app_screens/ipd/advise_investigation_table.dart';
...
import 'package:swasthyasetu/app_screens/ipd/mo_notes_screen.dart';
    ...
    try{
      ...
      if (model.status == "OK") {
        ...
        if (file1List.isNotEmpty) {
          ...
          String baseDischargeSummaryViewURL = "${baseURL}images/DischargeSummary/";
