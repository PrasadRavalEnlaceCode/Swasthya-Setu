...
class TreatmentSheetScreen extends StatefulWidget {
  ...
  @override
  State<TreatmentSheetScreen> createState() => _TreatmentSheetScreenState();
}

class _TreatmentSheetScreenState extends State<TreatmentSheetScreen> {
