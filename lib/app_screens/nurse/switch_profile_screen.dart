...
class _SwitchProfileScreenState extends State<SwitchProfileScreen> {
  ...
  void loadSelectedOrganization() {
    ...
    setState(() {
      selectedRoleName = prefs.getString('selectedOrganizationName') ?? "Swasthaya Setu";
    });
                        ...
                        children : [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: selectedRoleName == listRoles[index]["RoleName"]
                                    ? Colors.green
                                    : Colors.transparent,
                      ...
                      onTap: () {
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: Text("Switch Role"),
                              content: Text("Do you want to switch to ${listRoles[index]["RoleName"]}?"),
                              actions: <Widget>[
                                TextButton(
                                  onPressed: () {
                                ...
                                TextButton(
                                  onPressed: () {
                                    ...
                                    getRoleChangeSubmit(listRoles[index]["RoleName"]);
