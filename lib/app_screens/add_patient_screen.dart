...
class AddPatientScreenState extends State<AddPatientScreen> {
  ...
  Future<void> submitDataForUpdate(BuildContext context, File? image,
    ...
    if (model.status == "OK") {
      ...
      String updatedPatientIDP = jsonData[0]['PatientIDP'].toString();
      onUpdatePatientID(updatedPatientIDP);
  ...
  String getUpdatedPatientIDP() {
    // Add your logic to get the updated value (e.g., from a variable, controller, etc.)
    return patientIDP; // Return the updated value
  }
  ...
  @override
  void didUpdateWidget(AddPatientScreen oldWidget) {
