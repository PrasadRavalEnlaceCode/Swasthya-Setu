...
class ProviderFavouriteScreen extends StatefulWidget {
  String? patientIDP = "";
  final String urlFetchPatientProfileDetails =
      "${baseURL}provider_wishlist.php";
  ...
  ProviderFavouriteScreen(String patientIDP,String isFrom) {
  ...
  State<StatefulWidget> createState() {
    return ProviderFavouriteScreenState();
  }
}

class ProviderFavouriteScreenState extends State<ProviderFavouriteScreen> {
