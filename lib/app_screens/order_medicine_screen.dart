...
class OrderMedicineListScreen extends StatefulWidget {
  ...
  String emptyMessage = "There are no Medical Shops Available For Your Location";
...
class OrderMedicineListScreenState extends State<OrderMedicineListScreen> {
                                          ...
                                          children: <Widget>[
                                            InkWell(
                                              ...
                                              CircleAvatar(
                                                radius: 20,
                                                child: Icon(
                                                  Icons.storefront_sharp,size: 20,),
                                              ),
                                            ),
                                            SizedBox(
                                              width: SizeConfig
                                            ...
                                            InkWell(
                                              onTap: (){
                                                ...
                                                print('IsFavourite ${listDoctorsSearchResults[index]['IsFavourite']}');
  ...
  void callbackFromCountryDialog(String type) {
    ...
    setState(() {
      if (type == "City") {
        print("Selected City ID: --------------------------------------------${selectedCity.idp}");
