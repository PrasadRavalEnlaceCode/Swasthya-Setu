...
import 'package:silvertouch/app_screens/provider_favourite_screen.dart';
import 'package:silvertouch/app_screens/provider_order_screen.dart';
...
class OrderMedicineListScreen extends StatefulWidget {
  String patientIDP = "";
  ...
  String emptyMessage =
      "There are no Medical Shops Available For Your Location";

  Widget? emptyMessageWidget;

  OrderMedicineListScreen(String patientIDP) {
    this.patientIDP = patientIDP;
  }

  @override
  State<StatefulWidget> createState() {
    return OrderMedicineListScreenState();
  }
}

class OrderMedicineListScreenState extends State<OrderMedicineListScreen> {
  ...
  Widget titleWidget = Text("Pharmacy Store");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(size: SizeConfig.blockSizeVertical! * 2.5),
        actions: <Widget>[
          IconButton(
            onPressed: () {
              setState(() {
                if (icon.icon == Icons.search) {
                  debugPrint("Icon Color: ${icon.color}");
                                                      ...
                                                      onTap: () {
                                                        String?
                                                            ...
                                                            listDoctorsSearchResults[
                                                                ...
                                                                'HealthCareProviderIDP'];
                                                        print(
                                                            'IsFavourite ${listDoctorsSearchResults[index]['IsFavourite']}');
  ...
  void callbackFromCountryDialog(String type) {
    ...
    setState(() {
      if (type == "City") {
        print(
            "Selected City ID: --------------------------------------------${selectedCity.idp}");
  ...
  Future<String> saveRemovePatientFavouriteDetails(
      String? healthcareProviderIDP, String updateType) async {
    /*List<IconModel> listIcon;*/
    var doctorApiCalled = false;
    ProgressDialog pr = ProgressDialog(context);
    Future.delayed(Duration.zero, () {
