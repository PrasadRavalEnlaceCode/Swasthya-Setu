...
List<Map<String, dynamic>> listDiagnosisDetails = <Map<String, dynamic>>[];

class DiagnosisMasterListScreen extends StatefulWidget {
  String masterName;
  int masterId;

  DiagnosisMasterListScreen(this.masterName, this.masterId);
  @override
  State<StatefulWidget> createState() {
    return DiagnosisMasterListScreenState();
  }
}

class DiagnosisMasterListScreenState extends State<DiagnosisMasterListScreen> {
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              TextButton(
                  onPressed: () {
                    Navigator.pop(context);
                    deleteDiagnosisMaster(contextMain, idp);
                  },
                  child: Text("Yes"))
            ],
          );
        ...
        if (model.status == "OK") {
          ...
          for (var i = 0; i < jsonData.length; i++) {
            ...
            Map<String, dynamic> diagnosisMap = {
              ...
              "DiagnosisMasterIDP": diagnosisMasterIDP,
            };

            listDiagnosisDetails.add(diagnosisMap);
  ...
  void deleteDiagnosisMaster(
    ...
    String jsonStr = "{" +
        ...
        ":" +
        "\"" +
        DiagnosisNameController.text.trim() +
        "\"" +
        "," +
        "\"" +
        "DiagnosisMasterIDP" +
