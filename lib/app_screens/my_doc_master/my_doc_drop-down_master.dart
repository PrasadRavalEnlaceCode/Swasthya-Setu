...
import 'package:swasthyasetu/app_screens/my_doc_master/add_edit_doc_master.dart';
...
class MyDocumentDropDownMasterListScreenState extends State<MyDocumentDropDownMasterListScreen> {
                        ...
                        return Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                        ...
                                        child: Row(
                                          children: <Widget>[
                                            ...
                                            Expanded(
                                              flex: 3,
                                              child: Text(
                                                listDropDownDetails[index]["Category"],
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: SizeConfig
                                                        .blockSizeHorizontal !*
                                ...
                                Visibility(
                                  visible: listDropDownDetails[index]["SystemData"] != "System Provided",
                                  child: InkWell(
                                    onTap: () {
                                      Navigator.push(context,
                                          MaterialPageRoute(
                                              builder: (context) {
                                                return AddEditDropdownMastersScreen(
                                                  listDropDownDetails[index]["DocumentCategoryIDP"],
                                                  "Edit",
                                                  serviceName:
                                                  listDropDownDetails[index]['Category'],
                                                );
  ...
  showConfirmationDialogForDeleteDiagnosisMaster(String idp,documentcatname , BuildContext contextMain) {
  ...
  void deleteDropDownMaster(BuildContext context, String documentCategoryIDP,documentcatname) async {
