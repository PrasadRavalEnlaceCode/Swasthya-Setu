...
class AddEditDropdownMastersScreen extends StatefulWidget {
  ...
  AddEditDropdownMastersScreen(this.idp, this.action,
      {this.serviceName});

  @override
  State<AddEditDropdownMastersScreen> createState() => _AddEditDropdownMastersScreenState();
}

class _AddEditDropdownMastersScreenState extends State<AddEditDropdownMastersScreen> {
