...
class ProviderDetailsScreenState extends State<ProviderDetailsScreen> {
  ...
  void confirmPrescription(String value, String reportName, String reportDate,
      String reportTime, String reportImage) {
    showDialog(
        context: context,
        barrierDismissible: false,
        // user must tap button for close dialog!
  ...
  Future<String> sendPrescriptionDetails(String patientReportIDP) async {
    final String urlFetchPatientOrder = "${baseURL}patient_order_submit.php";
    ProgressDialog pr = ProgressDialog(context);
    Future.delayed(Duration.zero, () {
      pr.show();
    });
